...
namespace WorkshopPlatform.Controllers
{
    public class WorkShopsController : Controller
    {
        ...
        public WorkShopsController(WorkShopDbContext context ,UserManager<IdentityUser> userManager,
        ...
        public async Task<IActionResult> WorKShopMessageReciver(Messages messages)
        {
            ...
            var WorkShopUserID = _httpContextAccessor.HttpContext.User.FindFirstValue(ClaimTypes.NameIdentifier);
