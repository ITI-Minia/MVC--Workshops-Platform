        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (await _roleManager.FindByNameAsync("Workshop") == null)
                    {
                        result = await _roleManager.CreateAsync(new IdentityRole("Workshop"));
                    }
                    if (result.Succeeded)
                    {
                    ...
                    #region create workshop profile
                    ...
                    #endregion create workshop profile
