    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkshopRates", x => new { x.UserProfileId, x.WorkShopId });
                    table.ForeignKey(
                        name: "FK_WorkshopRates_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkshopRates_WorkShops_WorkShopId",
                        column: x => x.WorkShopId,
                        principalTable: "WorkShops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkshopRates_UserProfileId_WorkShopId",
                table: "WorkshopRates",
                columns: new[] { "UserProfileId", "WorkShopId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkshopRates_WorkShopId",
                table: "WorkshopRates",
                column: "WorkShopId");
